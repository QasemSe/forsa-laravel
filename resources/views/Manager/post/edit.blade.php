        ...
        <div class="container">
                ...
                <div class="card card-custom">
                    <div class="card-header">
                        <h3 class="card-title">
                           <a href="{{ route('post.index') }}">{{ t('Posts') }}</a> /  {{ t('Add New post') }}
                        </h3>
                    ...
                    <!--begin::Form-->
                    <form id="form" method="POST" action="{{ route('post.update',$post->id) }}" autocomplete="off" enctype="multipart/form-data">
                        @csrf
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <select class="form-control" name="company_id">
                                        <option value="" selected disabled>{{ t('Company') }}</option>
                                        @foreach ($companies as $company)
                                            <option {{ $post->company_id == $company->id ? 'selected' : '' }}
                                ...
                                <div class="col-md-12 mt-8">
                                    ...
                                    <select class="form-control select2" id="kt_select2_3" multiple name="skills_id[]" >
                                        @foreach ($skills as $skill)
                                            <option
                                                @foreach ($post->skills as $user_skill)
                                ...
                                <div class="col-md-4 mt-5">
                                    <div class="form-group fv-plugins-icon-container">
                                        ...
                                        <div class="switch">
                                            <label>
                                              <input name="status" value="1" {{ $post->status == 1 ? 'checked' : '' }}  type="checkbox">
