            ...
            <div class="card card-custom gutter-b">
                <div class="card-header flex-wrap py-3">
                    <div class="card-title">
                        <h3 class="card-label">{{ t('Universities') }}</h3>
                    </div>
                    ...
                    <div class="card-toolbar">
                        ...
                        <!--end::Dropdown-->
                        <!--begin::Button-->
                        <a href="{{ route('university.add') }}" class="btn btn-primary font-weight-bolder">
    ...
    @push('scripts')
        ...
        <script type="text/javascript">
            ...
            $('#ok_button').click(function(){
                var url = "{{ route('university.delete',':id') }}";
        ...
        <script type="text/javascript">
            $(function () {
                var table = $('.datatable').DataTable({
                    ...
                    serverSide: true,
                    info: false,
                    ajax: "{{ route('university.getUniversityData') }}",
                    columns: [
