        ...
        <div class="container">
                ...
                <div class="card card-custom">
                    <div class="card-header">
                        <h3 class="card-title">
                           <a href="{{ route('university.index') }}">{{ t('Universities') }}</a> /  {{ t('Edit university Data') }}
                        </h3>
                    ...
                    <!--begin::Form-->
                    <form id="form" method="POST" action="{{ route('university.update',$university->id) }}" autocomplete="off">
                        @csrf
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label>{{ t('Name') }} </label>
                                        <input  name="name" value="{{ $university->name }}" type="text" class="form-control" />
                                    </div>
                                </div>
